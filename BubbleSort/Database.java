...
public class Database {
     ...
     // TODO 5: Declare two local variables n and swapped
         ...
         for (int i = 0; i < n - 1; i++) {
             ...
             for (int j = 0; j < n - 1 - i; j++) {
                 // TODO 7: Get references to two BubbleSort.Registration objects.
                //         The current registration is at index j and the next registration is at index (j + 1)
                 ...
                 //         value of the current registration is greater than that of the next BubbleSort.Registration object.
                 if(currentReg.license.compareTo(nextReg.license)>0){
                    // TODO 14: Swap the positions of the current and next
                    //          BubbleSort.Registration objects in the array
    ...
    public static void main(String[] args) {
        ...
        // TODO 1: Create an instance of the BubbleSort.Database class
        System.out.println("\n******* Unsorted List ******\n");
        Database db = new Database();

        // TODO 2: Call the printAll() method on the BubbleSort.Database instance
        db.printAll();

        System.out.println("\n******* Sorted List ******\n");

        // TODO 8: Call the bubbleSort() method on the BubbleSort.Database instance
        db.bubbleSort();
