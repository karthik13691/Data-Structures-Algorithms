...
public class Database {
    ...
    public void insertionSort() {
        /* TODO 2: Set a local variable, regCount, equal to the size of the registrations array */
        int regCount = registrations.size();

        /* TODO 3: Create a for-loop that starts with unsorted_Indx = 1 and ends at i < regCount */
        for (int unsortedIndx = 1; unsortedIndx < regCount; unsortedIndx++) {
            ...
            while (sortedIndx >= 0) {
                ...
                if (sortedReg.license.compareTo(unsortedReg.license) > 0) {
                    ...
                    /* TODO 11: If the sortedReg license is greater than the
                        ...
                        sortedIndx + 1 to the sortedReg and Decrement the sortedIndx */
            ...
            /* TODO 13: After the while-loop but before returning to the
                top of the for-loop, set the element at sortedIndx + 1 to the unsortedReg */
    ...
    public static void main(String[] args) {
        Database db = new Database();
            /* TODO 8: Replace the invocation of the bubbleSort() method with an invocation of the insertionSort()             */
        System.out.println("\n******* UnSorted List ******\n");
        db.printAll();
        db.insertionSort();
        System.out.println("\n******* Sorted List ******\n");
